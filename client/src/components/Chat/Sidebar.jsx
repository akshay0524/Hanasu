                        ...
                        {friends.map(friend => (
                            ...
                            >
                                <div className="relative flex-shrink-0">
                                    ...
                                    <div className={`absolute bottom-0 right-0 w-2.5 h-2.5 rounded-full border-2 border-[var(--bg-primary)] ${onlineUsers.has(friend._id) ? 'bg-green-400' : 'bg-red-500'}`}></div>
                                </div>
